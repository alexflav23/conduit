...
- ⬜ Minor tail: GL↔Xero + inventory↔counts reconciliation *types* (the engine + REST exist; these are two more tie definitions), and a signed evidence-export pack (D21). Neither blocks close/lock or the audit story.
