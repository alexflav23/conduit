...
object DepletionForecast {
  ...
  // weekly: (week-start, units activated that week), ascending. onShelf: current on-shelf units. anchor: "today".
  def project(weekly: List[(LocalDate, Int)], onShelf: Int, anchor: LocalDate): Json = {
